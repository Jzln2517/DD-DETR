...
__all__ = ['TransformerEncoderLayer_LocalWindowAttention', 'AIFI_LPE', 'TransformerEncoderLayer_DAttention', 'TransformerEncoderLayer_HiLo', 
           ...
           'TransformerEncoderLayer_TSSA', 'TransformerEncoderLayer_ASSA', 'DSA_Block']
...
class SSA_GroupNorm(torch.nn.GroupNorm):
    """
...
class APS_SSA(torch.nn.Module):
    ...
    def __init__(self, dim):
        ...
        self.pre_norm = SSA_GroupNorm(self.pdim)
