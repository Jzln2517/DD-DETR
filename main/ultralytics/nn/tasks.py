...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
                 ...
                 ConvNormLayer, C3_Attention, C2f_Attention,DySnakeConv, C3_Conv3XC, C2f_Conv3XC, Conv3XCC3, C3_AggregatedAtt, C2f_AggregatedAtt, SPDConv,SimpleStem, VisionClueMerge, VSSBlock_YOLO, XSSBlock, WTConv2d,LDConv,RepHMS,C2f_LFI
                 ):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in (DySnakeConv,):
                c2 = c2 * 3        
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C3_Attention, C2f_Attention, C3_Conv3XC, C2f_Conv3XC, Conv3XCC3, C3_AggregatedAtt, C2f_AggregatedAtt,XSSBlock,C2f_LFI
                    ):
                ...
                n = 1
                   ...
                   TransformerEncoderLayer_Pola, TransformerEncoderLayer_TSSA, TransformerEncoderLayer_ASSA,DSA_Block):
            c2 = ch[f]
            args = [ch[f], *args]
            ...
            c2 = m.channel
                   ...
                   FocusedLinearAttention, TransNeXt_AggregatedAttention, HiLo, ELA, CAA,  LocalWindowAttention, EfficientAdditiveAttnetion, AFGCAttention, DFEM, AttentiveLayer
