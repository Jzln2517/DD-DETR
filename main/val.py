...
if __name__ == '__main__':
    model_path = r'E:\Code\DD-DETR\main\runs\train\DD_DETR-300\weights\best.pt'
    model = RTDETR(model_path) # 选择训练好的权重路径
    result = model.val(data=r'E:\Code\DD-DETR\main\dataset\visdrone.yaml',
                      split='test', # split可以选择train、val、test 根据自己的数据集情况来选择.
                      imgsz=640,
                      batch=4,
                      save_json=True, # if you need to cal coco metrice
                      project='runs/test-visdrone-5070',
                      name='DD_DETR-300',  
                      )
